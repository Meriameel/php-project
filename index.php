		...
		<div class="container">
		    <h3 class="wthree_text_info">New <span>Arrivals</span></h3>		
				<div id="horizontalTab">
                    ...
                    <?php $products = $DB->query("SELECT * FROM products WHERE category='Men'"); ?>
					<?php foreach ( $products as $product ) : ?>
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/<?php echo $product->id ; ?>.jpg" alt="" class="pro-image-front">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price"><?php echo number_format($product->price,2) ; ?>DH</span>
										</div>
                    ...
                    <?php $products = $DB->query("SELECT * FROM products WHERE category='Women'"); ?>
					<?php foreach ( $products as $product ) : ?>
							 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
